      ...
      <div className="relative z-20 container mx-auto px-6">
        ...
        <div className="relative rounded-3xl bg-white/70 backdrop-blur-[1px] p-6 sm:p-8 lg:p-12 shadow-[var(--shadow-card)]">
          ...
          {/* Actual 2-col content inside the unified “level”
              Make text wider than image on lg+ screens */}
          <div className="grid gap-12 lg:gap-16 items-center lg:[grid-template-columns:0.85fr_1.15fr]">
            {/* Image zone */}
            ...
            <div className="relative">
              ...
              <div className="relative">
                ...
                <div className="space-y-6 text-lg text-construction-gray leading-relaxed">
                  <p>
                    Framing isn't just one of many services — it's all we do. Our crews are
                    dedicated specialists who ensure every project starts strong, stays on
                    schedule, and meets the highest standards of quality.
                  </p>
                  <p>
                    With years of experience in residential construction across Alberta, we
                    understand that proper framing is the foundation of every successful
                    build. That's why builders trust us to deliver structural integrity that
